          ...
          <div className="space-y-12">
            ...
            <div className="flex">
              <div className="mr-4 mt-1">
                <FaCircleCheck size={24} className="text-[#0E1E4B]" />
              </div>
              <div>
                <h3 className="text-xl text-[#0F0E47]">
            ...
            <div className="flex">
              <div className="mr-4 mt-1">
                <FaShield className="h-6 w-6 text-[#0E1E4B]" />
              </div>
              <div>
                <h3 className="text-xl text-[#0F0E47]">
            ...
            <div className="flex">
              <div className="mr-4 mt-1">
                <RiLineChartFill className="h-6 w-6 text-[#0E1E4B]" />
              </div>
              <div>
                <h3 className="text-xl text-[#0F0E47]">
                  Affordable & Scalable
